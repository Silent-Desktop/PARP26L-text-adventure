...
main :: IO ()
main = do
  let state = GameState {pickedUpTowel = False, openedPaperBox = False, actionCount = 0, dishwasherRunning = True, cansFound = replicate 12 False, inventory = [], pickedUpKnifeInKitchen = False, pickedUpChair = False, pickedUpBoots = False, pickedUpKeys = False, stringFound = False}
