...
main :: IO ()
main = do
  let state = GameState {actionCount=0,dishwasherRunning = True, cansFound = replicate 8 False, inventory = [], pickedUpKnifeInKitchen = False, pickedUpChair = False,pickedUpBoots=False,pickedUpKeys=False}
